...
def plot_telemetry(
    ...
    *,
    ...
    # -----------------------------
    show_speed: bool = False,         # this is the basic speed tracking plot (speed vs target)
    show_braking_view: bool = False,  # this is the new LiDAR+braking tuning view with shaded hazard regions instead of a spike line
    ...
    show_cone_params: bool = False,   # the LiDAR hazard cone parameters (yaw and width)
    ):
    ...
    if not any([show_speed, show_braking_view, show_controls, show_lane_metrics, show_cone_params]):
